...
- **Monitor Size Comparison** — true-to-scale side-by-side comparisons of different screen sizes, resolutions, aspect ratios, and curvatures, in front and top-down views, with an optional desk overlay.
- **Monitor Simulator in 3D** — see how a monitor, flat or curved, fills your vision from where you sit. It renders the panel in 3D at a natural (≈43mm "normal-lens") perspective with real on-screen content; set your eye-to-screen distance and turn your head (drag, or arrow keys) to explore how much of the screen — and how much curvature distortion — you actually perceive. A top-down diagram shows the same scene with your field of view drawn as rays.
