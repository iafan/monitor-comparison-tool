...
export const MONITOR_CLASSES: MonitorClass[] = [
  ...
  // 26.5″
  { id: '26.5-2560x1440', diagonal: 26.5, resWidth: 2560, resHeight: 1440, curveRadius: null },
  { id: '26.5-3840x2160', diagonal: 26.5, resWidth: 3840, resHeight: 2160, curveRadius: null },
  // 27″
  ...
  { id: '31.5-3840x2160', diagonal: 31.5, resWidth: 3840, resHeight: 2160, curveRadius: null },
  { id: '31.5-6016x3384', diagonal: 31.5, resWidth: 6016, resHeight: 3384, curveRadius: null },
  ...
  { id: '32-6144x3456', diagonal: 32, resWidth: 6144, resHeight: 3456, curveRadius: null },
  // 34″ (ultrawide)
  ...
  { id: '34-3440x1440-1900r', diagonal: 34, resWidth: 3440, resHeight: 1440, curveRadius: 1900 },
  // 37.5″ / 39″ (ultrawide)
  ...
  { id: '39-5120x2160-1500r', diagonal: 39, resWidth: 5120, resHeight: 2160, curveRadius: 1500 },
  // 40″ (ultrawide 5K2K)
  ...
  // 51.5″ / 52″ (super ultrawide 6K)
  { id: '51.5-6144x2560-4200r', diagonal: 51.5, resWidth: 6144, resHeight: 2560, curveRadius: 4200 },
  { id: '52-5120x2160-1000r', diagonal: 52, resWidth: 5120, resHeight: 2160, curveRadius: 1000 },
